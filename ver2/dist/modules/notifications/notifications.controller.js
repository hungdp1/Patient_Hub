...
async function list(req, res) {
    const data = await svc.listMine(req.query, actor(req));
    res.json({ data });
}
...
async function markRead(req, res) {
    const data = await svc.markRead(req.params['id'], actor(req));
    res.json({ data });
}
...
async function broadcast(req, res) {
    const data = await svc.broadcast(req.body, actor(req));
