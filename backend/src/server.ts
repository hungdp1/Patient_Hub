...
import { initializeRealTimeServer, getRealTimeIO } from './realtime/socketServer';
...
app.get('/api/health', (_req, res) => {
  res.json({ status: 'Backend is running!', realtime: 'Socket.io connected' });
});
...
httpServer.listen(PORT, () => {
  ...
  console.log(`🔌 Real-time server (Socket.io) initialized`);
});
