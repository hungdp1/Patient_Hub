...
import { createAppointment, getAppointments, updateAppointment, getLabResults, createLabResult, updateLabResult, getMedicalRecords, createMedicalRecord, updateMedicalRecord, getPrescriptions, createPrescription, updatePrescription, getPayments, getHospitalServices, getLibraryDiseases, getLibraryDrugs, getLibraryProcedures, getLibraryLabTests, getCreditCards, createCreditCard, createPayment, getNotifications, markNotificationAsRead, } from '../controllers/dataController';
const router = Router();
// Public routes
